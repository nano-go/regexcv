...
public class Digraph {
  ...
  private static final ReductionRuler[] RULES = {
    newRuler("\\\\w", RANGE_A_Z, RANGE_a_z, RANGE_0_9), newRuler("any char", RANGE_ANY),
  };
  ...
  public static class SpecialAcception implements Acception {
    ...
    public boolean equals(Object obj) {
      return obj instanceof SpecialAcception && ((SpecialAcception) obj).label.equals(label);
    }
  }
  ...
  public static class Node {
    ...
    public Set<Node> getNodes(Acception in) {
      return Objects.requireNonNullElse(edges.get(in), Collections.<Node>emptySet());
    }
  ...
  /**
   * s0['a-e'] = s1 s0['f'] = s1 s0['a-z'] = s1
   *
   * <p>will be merged: s0['a-z'] = s1
   */
